...
#if defined(SN_CONFIG_FILE)
#include SN_CONFIG_FILE
#endif  
...
#define BOARD_PORT_FILE                "SN-D02GS01J_REV_V1.0.c"
#endif                              
...
/* 串口调试LOG输出 */
#ifndef CONFIG_SN_LOG_UART
#define CONFIG_SN_LOG_UART                  HAL_UART0_BASE
#endif
...
#ifndef UART_PAD_OPENDRAIN_MODE_EN
#define UART_PAD_OPENDRAIN_MODE_EN        0   //UART引脚开启开漏模式，支持5V电平。0:关闭开漏模式；1：开启开漏模式。
#endif
...
#define IF_JUST_CLOSE_HPOUT_WHILE_NO_PLAY    0//没有播报的时候只关HP：0：没有播报的时候关DAC（省电，但是蓝牙播报的时候会干扰ADC）
                                                                    //1：没有播报的时候只关HPOUT，不关ADC（解决蓝牙播报干扰ADC的问题）
#endif    

#define SN_CHIP_TYPE 1302
/************* 时钟源配置选择 *************************/
#ifndef USE_EXTERNAL_CRYSTAL_OSC
#define USE_EXTERNAL_CRYSTAL_OSC             0  //是否使用外部晶振。0：不使用外部晶振时钟；1：使用外部晶振时钟；默认使用内部振荡器时钟。
#endif
