 ...
 * @brief   A sample code use SNR991X PWM control RGB or RGBW light, used HSV 
 *         color space.
 * @version V1.0.0
 * @date 2018-05-23
 * 
 ...
 * @brief A sample code use SNR991X PWM control RGB or RGBW light, used HSV color space
 * @{
 */
