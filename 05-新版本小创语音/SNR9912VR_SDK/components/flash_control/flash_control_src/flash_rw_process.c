...
//     {
//         sn_logerr(LOG_FLASH_CTL,"flash_ctl_xSemaphore creat fail\r\n");   
//         return RETURN_ERR;
//     }
...
//     {
//         sn_logerr(LOG_FLASH_CTL,"dnn_cpu_mode_semaphore creat fail\r\n");   
//         return RETURN_ERR;
//     }
//     dnn_dnn_mode_semaphore = xSemaphoreCreateBinary();
//     if(NULL == dnn_dnn_mode_semaphore)
//     {
//         sn_logerr(LOG_FLASH_CTL,"dnn_dnn_mode_semaphore creat fail\r\n");   
//         return RETURN_ERR;
//     }
...
//     //sn_loginfo(SN_LOG_INFO,"get flash_ctl_xSemaphore\n");
...
// 	// {
// 	// 	SN_ASSERT(0, "send requset flash msg err!\n");
// 	// }
...
//     else
//     {
//         SN_ASSERT(0,"take flash ctrl timeout!\n");
//         //return RETURN_ERR;
//     }
// }
...
// //     sn_logdebug(LOG_FLASH_CTL,"FLASH R Start!\n");
// //     sn_logdebug(LOG_FLASH_CTL,"addr = 0x%x ,buf = 0x%x ,size= 0x%x \n",addr,buf,size);
...
//     sn_logdebug(LOG_FLASH_CTL,"FLASH W Start!\n");
//     sn_logdebug(LOG_FLASH_CTL,"addr = 0x%x ,buf = 0x%x ,size= 0x%x \n",addr,buf,size);
...
//     sn_logdebug(LOG_FLASH_CTL,"FLASH E Start!\n");
//     sn_logdebug(LOG_FLASH_CTL,"addr = 0x%x, size= 0x%x \n",addr,size);
