 ...
 * 
 */
#ifndef _SNR991X_LOWPOWER_H_
#define _SNR991X_LOWPOWER_H_
 ...
 * @defgroup snr991x_lowpower snr991x_lowpower
 * @brief SNR991X芯片电源管理驱动
 * @{
 */
