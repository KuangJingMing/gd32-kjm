/**
 * @file snr991x_codec.h
 * @brief SNR991X inner codec驱动的头文件
 * @version 0.1
 * @date 2019-05-10
 * 
 ...
 * @defgroup snr991x_codec snr991x_codec
 * @brief SNR991X芯片inner CODEC驱动
 * @{
 */
...
typedef struct 
{
    ...
    //!使用SNR991X的ALC控制inner CODEC还是使用其本身的ALC控制
    inner_cedoc_gate_t use_snr991x_alc;
    //!ALC开关
