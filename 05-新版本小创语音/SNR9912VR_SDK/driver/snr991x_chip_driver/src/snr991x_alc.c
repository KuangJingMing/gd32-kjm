...
/**
 * @brief 配置SNR981x中的ALC左通道的参数（这只是左通道的ALC一些参数的配置，
...
/**
 * @brief 配置SNR981x中的ALC右通道的参数（这只是右通道的ALC一些参数的配置，
...
/**
 * @brief 配置SNR981x中的ALC GLB_CTRL寄存器的配置
 * 
