...
#ifndef SNR991X_SCU_H
#define SNR991X_SCU_H
...
#define MAIN_FREQUENCY          240000000

#elif ((SN_CHIP_TYPE == 1302) || (SN_CHIP_TYPE == 1303))
...
#define SRC_FREQUENCY           12288000U
...
{
    //!PLL倍频前的时钟
    DTR_CLK_SEL_PLL_BEFORE = 0,
    //!PLL倍频后的时钟
    DTR_CLK_SEL_PLL_AFTER  = 1,
}Dtr_Clk_Sel_t;
