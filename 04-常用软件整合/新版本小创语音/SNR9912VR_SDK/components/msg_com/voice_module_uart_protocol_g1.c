...
{    
    ...
    if((SN_TX_START < g1_com_data->cmd) &&(SN_TX_END > g1_com_data->cmd))
    {
    ...
    {  
	 ...
	 #endif
        if((SN_RX_START < g1_com_data->cmd) &&(SN_RX_END > g1_com_data->cmd))
        {
            switch(g1_com_data->cmd)
            {
                case SN_RX_CHK_EN://checksum enable
                    #if 0 //二代对应修改
                    gs_uar2_user.chk_enable = g1_com_data->data0;
		      #endif
                    mprintf("rx cmd = %d,data=%d\r\n",g1_com_data->data0,g1_com_data->data1);
                break;        
                case SN_RX_ECHO_EN://echo enable
                    #if 0 //二代对应修改
                    gs_uar2_user.echo = g1_com_data->data0;
		      #endif
                    mprintf("rx cmd = %d,data=%d\r\n",g1_com_data->data0,g1_com_data->data1);
                break;
                case SN_RX_PLAY_INDEX://play wav index (com_data->data0)
                ...
                case SN_RX_RESET://play wav index (com_data->data0)
                ...
                break;
                case SN_RX_VOLSET://play wav index (com_data->data0)
                ...
                case SN_RX_REV:
                {
                    ...
                    g1_com_data->cmd= SN_TX_REV;//(tmp_data>>16);
